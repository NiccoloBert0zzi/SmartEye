...
target_points = [(100, 100), (1820, 100), (1820, 960), (100, 960)]
calibration_points = []
...
def capture_hand_landmarks():
    ...
    for i, point in enumerate(target_points):
        while True:
            ...
            cv2.putText(calibration_image, f'Point {i + 1}', (point[0] + 30, point[1] - 30), cv2.FONT_HERSHEY_SIMPLEX,
                        1, (255, 255, 255), 2)
            ...
            cv2.moveWindow("Calibration Targets", width, 0)
            ...
            if key == 13:  # Enter key
                if results.multi_hand_landmarks:
                    for hand_landmarks in results.multi_hand_landmarks:
                        # Assuming we use the index fingertip landmark (landmark 8)
